...
from supply.models import Supplier, Article, ArrivoFood
...
def import_verdurefreche():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val.xlsx')
    ws = wb.active
...
def import_fruttafreca():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_frutta.xlsx')
    ws = wb.active
...
def import_carnefreca():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_carni_fresceh.xlsx')
    ws = wb.active
...
def import_latt():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_latt.xlsx')
    ws = wb.active
...
def import_grassi():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_grassi.xlsx')
    ws = wb.active
...
def import_cereali():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_cereali.xlsx')
    ws = wb.active
...
def import_vercong():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_vercong.xlsx')
    ws = wb.active
...
def import_vercons():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_valvercons.xlsx')
    ws = wb.active
...
def import_proddolc():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_proddolc.xlsx')
    ws = wb.active
...
def import_ittfrechi():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_itticifreschi.xlsx')
    ws = wb.active
...
def import_frutcons():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_fruttcons.xlsx')
    ws = wb.active
...
def import_carnicons():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_carnicons.xlsx')
    ws = wb.active
...
def import_spezie():
    wb = load_workbook('/home/mate/Documenti/food_ingredient_val_spezie.xlsx')
    ws = wb.active
